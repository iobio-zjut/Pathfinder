	...
	namespace abinitio
	{
		...
		*/
		...
		public:
			...
			void mkdir(std::string &file_name);
			void Output_SPICKER_All_Data(core::pose::Pose pose, Real energy);
			void SPICKER_Demand_All(core::pose::Pose Pose);
			void Read_parameters();
			void get_parameters(std::map<std::string, std::string> &parametersMap);
			void initial_file();
			void sampling(core::pose::Pose &pose);
			///......................................................................
